...
if (isset($_GET['del'])) {
    ...
    try {
        // Verificar se o item tem estoque ou movimentações antes de excluir
        ...
        if ($item_check && $item_check['quantidade_atual'] > 0) {
            ...
            // Verificar se há entradas ou saídas associadas
...
// Buscar categorias existentes para o select
...
try {
    ...
    // Ignorar erro, continuar com array vazio
}
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body>
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="itensDropdown">
                        ...
                        <li>
                            <a class="dropdown-item" href="itens_cadastrados.php">
                                <i class="bi bi-boxes"></i> Itens Cadastrados
                            </a>
                        </li>
                        <li>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              name="descricao" 
                                              rows="3"
                                              placeholder="Descrição detalhada do item"><?= htmlspecialchars($item['descricao']) ?></textarea>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              name="observacoes" 
                                              rows="2"
                                              placeholder="Observações adicionais"><?= htmlspecialchars($item['observacoes']) ?></textarea>
                                </div>
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <a href="itens.php" class="btn btn-sm btn-success">
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        <div class="alert alert-info mb-0">
                            ...
                            <a href="itens.php" class="alert-link">Cadastre seu primeiro item</a>.
                        </div>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (codigoInput && !codigoInput.value && !<?= $id_edit > 0 ? 'true' : 'false' ?>) {
